...
class App(tk.Frame):
	...
	def launchpcc(self):
		...
		Label(searchApp, text="(hint:#) Admin\'s Password: ").grid(row=0)
		...
		def callback():
			...
			#chromeDriver = 'C:\\Users\\dof344\\Desktop\\Work Documents\\Work Projects\\Work Scripts\\WORKSPACE\\driver\\chromedriver.exe'
	...
	def imprivataCortext(self):
		...
		ttk.Label(searchApp, text="User\'s Lastname: ").grid(row=2) 
		...
		def callback():
			...
			#usr = 'dforbes@kaleidahealth.org'
			# Hard code Password, not AD attached, can implement change to prompt
	...
	def launchAnakam(self):
		...
		# LOGO
		# bg_img = PhotoImage(file = 'J:\\Information Systems & Technology\\ALL IS&T\\dof_Workspace\\img\\anakam_bg.png').subsample(1,1)
	...
	def launchStars(self):	
		...
		def callback():
			...
			ie_driver = webdriver.Ie("J:\\Information Systems & Technology\\ALL IS&T\\dof_Workspace\\driver\\IEDriverServer.exe")
			#ie_driver = webdriver.Ie("C:\\Users\\dof344\\Desktop\\IEDriverServer.exe") # HOOME PC exe location
			ie_driver.get(portal)
			delay = 3
	...
	def submitButton(self):
		...
		# Dummy Account
		smtpObj.login('pytonlogin','Br00klyn11233')

		#print('*'*10)
		#print('Login completed')
		#print('Sending Email')
		smtpObj.sendmail('pythonlogin', '******@email.com','Subject: Issue Submitted\n'
...
# WIP
# TODO: infoclique password reset
